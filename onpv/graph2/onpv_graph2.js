...
*/
/*Initiate data*/
d3.csv("onpv_graph2_chart.csv", function(d,i,columns){
...
let message = "documentHeight2:"+documentHeight; // Add some unique identifier to the string being passed
...
window.onresize = function() {
	...
	if ( heightDiff > 10 | heightDiff < -10 ) {
		...
		message = "documentHeight2:"+documentHeight;
